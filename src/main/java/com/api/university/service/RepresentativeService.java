...
public interface RepresentativeService {
    ...
    public void createRepresentative(String repname, String email, String phonenumber,
                                     String profilepic, String username, String password, String universityID, String availability, String zone);
    ...
    public void updateRepresentative(String repname, String email, String phonenumber,
                                     String username, String password, String universityid, String availability, int id, String zone);
}
